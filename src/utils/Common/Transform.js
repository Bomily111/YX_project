...
var ScreenToWGS84Type;
(function (ScreenToWGS84Type) {
    ScreenToWGS84Type[ScreenToWGS84Type["CameraClass"] = 0] = "CameraClass";
    ScreenToWGS84Type[ScreenToWGS84Type["SceneClass"] = 1] = "SceneClass";
})(ScreenToWGS84Type || (ScreenToWGS84Type = {}));
var WGS84ToCartographicType;
(function (WGS84ToCartographicType) {
    WGS84ToCartographicType[WGS84ToCartographicType["EllipsoidClass"] = 0] = "EllipsoidClass";
    WGS84ToCartographicType[WGS84ToCartographicType["CartographicClass"] = 1] = "CartographicClass";
})(WGS84ToCartographicType || (WGS84ToCartographicType = {}));
/**
 ...
 * @return {*}
 */
export function screenToCartesian3(screenPosition, type = ScreenToWGS84Type.SceneClass) {
 ...
 */
export function cartesian3ToScreen(cartesian3) {
    let viewer = DTScopeEngine.viewer;
 ...
 */
export function cartesian3ToCartographic(cartesian3, type = WGS84ToCartographicType.CartographicClass) {
 ...
 * @return {*}
 */
export function cartographicToCartesian3(cartographic) {
 ...
 * @return {*}
 */
export function cartographicArrayToCartesian3(pnts) {
 ...
 * @return {*}
 */
export function cartographicArrayHeightsToCartesian3(pnts) {
