...
.directory-row { display: flex; align-items: center; gap: 11px; width: 100%; min-height: 44px; padding: 0 18px; box-sizing: border-box; color: #7892aa; font-family: inherit; font-size: 14px; text-align: left; border: 0; border-bottom: 1px solid rgba(0, 150, 220, .07); background: transparent; }
.home-row { cursor: pointer; transition: .18s ease; }
.home-row strong { color: #b9cee0; font-size: 14px; font-weight: 600; }
...
.directory-node strong { color: inherit; font-size: 14px; font-weight: 500; }
...
.module-link span{color:#4e85aa;text-align:center;font-size:15px}.module-link strong{font-size:14px;font-weight:500}.module-link em{color:#456b87;font-size:18px;font-style:normal}.module-link:hover{color:#dffaff;background:rgba(0,170,235,.07)}.module-link:hover span,.module-link:hover em{color:#69dff2}
