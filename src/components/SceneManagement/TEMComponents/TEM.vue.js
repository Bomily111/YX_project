...
import TEMColorBar from '../Colorbars/TEMColorBar.vue';
...
let tunnel_selected = ref('瞬变电磁'); //里程选择默认加载
...
if (__VLS_ctx.selectedRow || __VLS_ctx.modelLoadedDirectly) {
    const __VLS_15 = TEMColorBar;
    // @ts-ignore
    const __VLS_16 = __VLS_asFunctionalComponent1(__VLS_15, new __VLS_15({}));
    const __VLS_17 = __VLS_16({}, ...__VLS_functionalComponentArgsRest(__VLS_16));
}
// @ts-ignore
[selectedRow, modelLoadedDirectly,];
