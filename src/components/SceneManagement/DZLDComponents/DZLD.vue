<!--
 * @Author: LNX222
 * @Date: 2025-06-30 11:51:00
 * @LastEditors: LNX222
 * @LastEditTime: 2025-06-30 11:51:00
 * @FilePath: Geology-v3\src\views\SceneManagement\ConstructionSurfaceGeoModel\Component\DZLDComponents\DZLD.vue
-->
...
<template>
  <div>
    ...
    <!-- 雷达剖面浮动面板 -->
    <GPRRadargram :initialX="310" :initialY="480" />
    <!-- 右侧面板 -->
...
import MileageSelect from './Modules/MileageSelect_D.vue';
import Panel from './Modules/Panel.vue'; // 新增：引入Panel组件
import GPRRadargram from './Modules/GPRRadargram.vue';
...
let tunnel_selected = ref('地质雷达'); //里程选择默认加载
...
function handleSelectRow(row) {
  ...
  showPanel.value = !!row; // 只要没有选中就关闭面板
}
