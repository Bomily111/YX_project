 ...
 * @FilePath: Geology-v3\src\views\SceneManagement\ConstructionSurfaceGeoModel\Component\DBHComponents\DBH.vue
-->
...
<template>
  <div>
    ...
    <div class="right-panel" v-if="selectedRow">
      ...
      <DBHInfoDetailPanel :pkinfo="selectedRow?.value?.pkinfo" />
    </div>
  </div>
</template>
...
import DBHInfoDetailPanel from './Modules/DBHInfoDetailPanel.vue';
...
let tunnel_selected = ref('加深炮孔'); //里程选择默认加载
