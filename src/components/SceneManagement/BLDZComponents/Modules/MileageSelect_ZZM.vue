 ...
 * @FilePath: Geology-v3\src\views\SceneManagement\ConstructionSurfaceGeoModel\Component\AHDComponents\Modules\MileageSelect_AHD.vue
-->
<template>
  <div>
    <div class="outer">
      <header class="head">
        ...
        <div class="tunnel_select" >
          <select v-model="tunnel_selectedOption" @change="(e) => emit('changeTunnel', e.target.value, tunnelType)" >
      ...
      <article class="article">
        <div class="middle">
          <div class="el_table">
            <el-table :data="currentPageData" ref="tableRef" highlight-current-row class="el_row_content" @selection-change="selectChange">
