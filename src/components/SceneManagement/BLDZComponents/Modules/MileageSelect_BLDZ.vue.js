...
const { default: __VLS_23 } = __VLS_21.slots;
{
    ...
    const [scope] = __VLS_vSlot(__VLS_24);
    let __VLS_25;
    ...
    const __VLS_31 = ({ click: {} },
        { onClick: (...[$event]) => {
                ...
                // @ts-ignore
                [handleTunnelSelectChange, tunnel_selectedOption, currentPageData, selectChange, lookAtTo,];
            } });
...
let __VLS_38;
const __VLS_39 = ({ sizeChange: {} },
    { onSizeChange: (__VLS_ctx.handleSizeChange) });
const __VLS_40 = ({ currentChange: {} },
    { onCurrentChange: (__VLS_ctx.handleCurrentChange) });
/** @type {__VLS_StyleScopedClasses['el_page']} */ ;
var __VLS_36;
var __VLS_37;
// @ts-ignore
[currentPage, background, pageSize, totalData, handleSizeChange, handleCurrentChange,];
